        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= BASE_URL ?>/admin/profile" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>E-mel</label>
                    <input type="text" value="<?= htmlspecialchars($u['email'] ?? '') ?>"
                           disabled class="input-disabled">
                    <small class="text-muted">E-mel akaun tidak boleh diubah.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone_number" name="phone_number"
                           value="<?= htmlspecialchars($u['phone_number'] ?? '') ?>">
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?= BASE_URL ?>/admin/dashboard" class="btn btn-ghost">Batal</a>
                </div>
            </form>
        </div>
    </div>
